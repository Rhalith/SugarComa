...
public class CreateEllipse : MonoBehaviour
{
    ...
    void Start()
    {
        positions = InstantiateEllipse(a, b, h, k, theta, resolution);
    ...
    Vector3[] InstantiateEllipse(float a, float b, float h, float k, float theta, int resolution)
    {
